...
description: "Standing scan (2026-06-29): root cause classes for wrong RCA, stale code, weak testing, flow confusion — mandatory gates in 10-quality-gates.md"
metadata:
  node_type: memory
  type: feedback
---
...
**Gate:** `30-kg-discipline.md` order: MEMORY → CANONICAL-MAP → validate → orient → **XML + processors** → db-local.
...
Related rules: `10-quality-gates.md`, `30-kg-discipline.md`, `30-kg-discipline.md`, `10-quality-gates.md`.
