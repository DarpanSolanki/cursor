...
Keep `/home/darpan/darpan/` clean and disk-lean — temp/scratch/stale files must not accumulate.
...
**Boundary:** all deletion stays inside `/home/darpan/darpan/` + `/tmp` session scratch (CLAUDE.md Rule 1, [[feedback_darpan_boundary]]). Pairs with [[feedback_keep_knowledge_current]] (no loose markdown islands either).
