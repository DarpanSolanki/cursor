...
**RULE (2026-07-23):** Build with `cd <service-repo> && ./gradlew build -x test` (Java 17). The old `/home/darpan/Documents/sliProd/gbuild.sh` + `.gradle-local` wrapper is **gone** — do not invent a parallel wrapper in the workspace.
