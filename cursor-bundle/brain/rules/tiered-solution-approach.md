---
description: For every issue/enhancement, always present tiered solutions — quick fix first (lowest TAT), then progressively better architectural options
alwaysApply: true
---
...
- **After every analysis / RCA / Jira triage / “what’s next?”**: emit a full **OPTIONS BOARD** — **L0 + L1 + L2 + L3** — before recommending a single next step. Planning engine: autopilot directive + `.cursor/rules/00-workspace-core.mdc` § Post-analysis OPTIONS BOARD.
