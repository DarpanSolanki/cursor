...
- Put performance, index usage, EXPLAIN notes, and schema rationale in **`.cursor/rules/accounting-module-knowledge.md`** (accounting) or **comments in Flyway SQL** / workspace docs — not in Java repository classes.
