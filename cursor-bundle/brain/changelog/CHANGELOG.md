# Changelog — shipped fixes (audit log for all commits)

> **KG flow precedents** — only entries tagged `| kg-flow |` or detail `KG-FLOW:` are indexed into `kg cases`. Everything else is human audit only. See [`README.md`](README.md).
...
## 2026-06-24 | `60c8d0f74f` | accounting-v2 | mfi_integration_v3.3.1.2 | kg-flow | DCF L0-L2 amount hardening
apiName loanDeathForeclosure GetAmountDetailsForDeathForeclosureService death-cycle PINT FEE credit INT waived billing sync death date DeathForeclosureInsuranceWriter LAN 6007564726

---


## 2026-06-24 | `dfcd270a37` | accounting-v2 | mfi_integration_v3.3.1.2 | kg-flow | DCF death-on-due-date settled EMI penal credit
apiName loanDeathForeclosure GetAmountDetailsForDeathForeclosureService calculateDeathCycleSettledPenalCredit dcf_death_cycle_penal_credit LAN 6007564726 outstanding 5158 balance claim 4842

---


## 2026-06-23 | acct `8053210a5` | accounting-v2 | feature/delayed_payment_interest | kg-flow | DPI billing next-EMI due_date + aggregated bill per anchor
apiName dpiBilling dpiAccrualBooking tables dpi_accrual_details loan_due_details transaction_master UD §5.4 next_installment value_date markBilledByInstallment DpiBatchNpaSupport

---


## 2026-06-23 | acct `346d9efe6` | accounting-v2 | feature/delayed_payment_interest | kg-flow | DPI client ref numeric format like interest jobs
apiName dpiBilling dpiAccrualBooking — client_reference_number loanAccountId+installmentId+millis (billing) loanAccountId+millis (accrual booking); fixes 134497 duplicate on cross-EOD replay

---


## 2026-06-23 | acct bfd172d86 | accounting-v2 | feature/delayed_payment_interest | kg-flow | Death FC DPI loss waiver + child NPA DPI leg
loanDeathForeclosure DeathForeclosureInsuranceWriter calculateLossDpiWaived BILLED_DPI_INT_WAIVED_AMT childLoanRepayment PAID_BILLED_DPI_INT_AMT npa_suspense_total_amount

---


## 2026-06-23 | acct `28a5f9ae6` | accounting-v2 | feature/delayed_payment_interest | kg-flow | DPI chunk cache chunk-size agnostic + finally eviction
apiName dpiAccrualCalculation dpiAccrualBooking dpiBilling — preload IN sub-batch 100; writer finally onAfterWrite; runtime force_chunk; getLoanAccountOverviewDetails dpic.overview_api

---


## 2026-06-23 | acct `2c98528d5` | accounting-v2 | feature/delayed_payment_interest | kg-flow | DPI 4 indexed reads + Java filters all 3 jobs
apiName dpiAccrualCalculation dpiAccrualBooking dpiBilling — findOpenUnpostedByLoanAccountIds findAccruedUnbilledByLoanAccountIds findMaxEndDateByLoanAccountIds findAllByLoanAccountIdAndInstallmentId; DpiAccrualRowFilters; verify-dpi PASS

---


## 2026-06-23 | acct `021662d48` | accounting-v2 | feature/delayed_payment_interest | kg-flow | DPI booking preload partial-index + chunk cache
apiName dpiAccrualBooking — findUnpostedAccruableByLoanAccountIds (idx_dpi_accrual_details_unposted_by_loan); DpiAccrualBookingChunkAccrualCache; verify-dpi PASS; max 1987 LANs + 199k history calc ~21s

---


## 2026-06-23 | acct `de404e830` | accounting-v2 | feature/delayed_payment_interest | kg-flow | DPI accrual scalable preload (partial index + MAX end_date)
apiName dpiAccrualCalculation preloadAccrualContextForCalculation findOpenUnpostedByLoanAccountIds findMaxEndDateByLoanAccountIds lazy seedCarryForInstallment max1987LANs 199kRows 15s verify-dpi PASS

---


## 2026-06-23 | acct `ebfdb51f10` | accounting-v2 | feature/delayed_payment_interest | kg-flow | DPI accrual preload: findAllByLoanAccountIds + Java reduce
apiName dpiAccrualCalculation preloadAccrualRowsForCalculation findAllByLoanAccountIds reduceRowsForAccrualCalc removed findOpenUnposted findLatestInstallmentRows chunk1000 read_count=1000 verify-dpi PASS

---


## 2026-06-22 | acct `e9f8d3348` | accounting-v2 | feature/delayed_payment_interest | kg-flow | DPI accrual narrow sub-batched chunk preload
apiName dpiAccrualCalculation — preloadAccrualRowsForCalculation open+latest-per-installment; sub-batch 100; noOpenInstallmentIds miss cache

---


## 2026-06-22 | acct `498979676` | accounting-v2 | feature/delayed_payment_interest | kg-flow | DPI accrual calc perf: preload + miss cache
apiName dpiAccrualCalculation — one findAllByLoanAccountId per loan; noOpenInstallmentIds; daily loop no N+1 on open row lookup

---


## 2026-06-22 | acct `d920c1caf8` | accounting-v2 | feature/delayed_payment_interest | kg-flow | DPI accrual installment_id — latest overdue INT EMI anchor
apiName dpiAccrualCalculation · dpi_accrual_details.installment_id · latestUnpaidIntDue replaces earliestUnpaidIntDue · cumulative overdue base unchanged · multi-EMI overdue stamps newer EMI

---


## 2026-06-22 | acct `09c3d9ef7a` | accounting-v2 | fix/sdcp-10199-parent-last-child-dfc-closure | kg-flow | SDCP-10199 parent zero OS on last-child DFC
apiName deathforeclosureInsuranceJob DeathForeclosureInsuranceWriter.doParentPartPrePayment lastActiveChild waive pending dues updateLoanAccountStatusProcessor parent CLOSED SDCP-10199 QA4 6011257029

---


## 2026-06-22 | acct ef57946ef | accounting-v2 | feature/delayed_payment_interest | kg-flow | Restructuring DPI API fields for webapp
apiName getLoanAccountOverviewDetails getLoanAccountBPIAmount total_accrued_dpi_amount bpd_amount getBrokenPeriodDpiAmountTillDate DpiAccrualDetailsDaoService response templates; ntest dpic.overview_api dpic.restructuring_bpi_api dpic.restructuring_smoke

---


## 2026-06-22 | acct 223bc2bbb | accounting-v2 | mfi_integration_v3.3.1.2 | kg-flow | Foreclosure CBC from LAN when scheme unconfigured (SDCP-10427)
apiName fetchLoanForeclosureSimulationDetails loanPrepayment — FetchLoanForeclosureSimulationDetailsProcessor.fetchCBCDetails resolveAppliedCbcChargeCodeFromLoanDues fallback only when product scheme has no CBC price setup; uses outstanding FEE loan_due_details charge_code; configured-scheme path unchanged; UpdateDueDetailsForPrepaymentProcessor.processCBCFee aligned

---


## 2026-06-22 | acct f5365c598 | accounting-v2 | feature/delayed_payment_interest | kg-flow | DPI skip accrual without go-live date
apiName dpiAccrualCalculation — DpiAccrualCalculationBatchService skips loan when DPI_GO_LIVE_DATE missing/invalid in masterdata; confirmed date required before any accrual; Day Zero floor unchanged when date present

---


## 2026-06-19 | acct a28dc0a14 | accounting-v2 | mfi_integration_v3.3.1.2 | kg-flow | Foreclosure fixes forward-port to release train 3.3.1.2
apiName loanPrepayment createPrepaymentDetailsProcessor expirePendingCollectionsProcessor SDCP-10400 SDCP-8102 SDCP-10255 ExpireLoanForeclosureService error 134365 cherry-pick from 3.3.1.1

---


## 2026-06-19 | acct 7d13ec7c4 | accounting-v2 | mfi_integration_v3.3.1.1 | kg-flow | Foreclosure: batch expiry unfreeze + duplicate pending guard (query ladder step 1)
apiName loanPrepayment createPrepaymentDetailsProcessor expirePendingCollectionsProcessor SDCP-10400 SDCP-8102 SDCP-10255 ExpireLoanForeclosureService CreatePrepaymentDetailsProcessor prepayment_details PENDING EXPIRED FORECLOSURE_FREEZE error 134365 findAllByLoanAccountNumbersAndStatus

---


## 2026-06-19 | acct be08e59cb | accounting-v2 | mfi_integration_v3.3.1.1 | kg-flow | Foreclosure release: batch expiry unfreeze + duplicate pending create guard
loanPrepayment createPrepaymentDetailsProcessor SDCP-10400 SDCP-8102 SDCP-10255 ExpireLoanForeclosureService prepayment_details PENDING EXPIRED FORECLOSURE_FREEZE

---


## 2026-06-18 | acct a8ad4a240 | accounting-v2 | feature/delayed_payment_interest | kg-flow | DPI async skip failure mapper unwrap
apiName dpiAccrualBooking dpiBilling — force_async skip listeners received FutureTask; DpiBatchWriterSkipItemSupport unwraps Future/List before loan_account_id in batch_failure_audit; fixes ClassCastException masking postTransaction errors

---


## 2026-06-18 | acct f09221144 | accounting-v2 | feature/delayed_payment_interest | kg-flow | DPI grace INT lookup + cold-path sum reuse
apiName dpiAccrualCalculation — resolveEarliestUnpaidIntDue via getDueDetailsByDueDateAndComponenetTypes + Java filter; DpiAccrualDetailsDaoService sums from findAllByLoanAccountId*; removed 4 redundant @Query; hot getOverdueBaseAmount unchanged

---


## 2026-06-16 | acct `82f5e1f8c5` | accounting-v2 | feature/delayed_payment_interest | kg-flow | BPD includes unposted accrued DPI
getBrokenPeriodDpiAmountTillDate = unbilled posted + unposted accrued; fetchLoanForeclosureSimulationDetails bpd_amount; markAccrualPostedTillDate before markBilled on foreclosure/part-prep; getPartPrepaymentBPIAmount returns bpd_amount

---


## 2026-06-16 | acct `60d94d93d6` | accounting-v2 | feature/delayed_payment_interest | kg-flow | DPI gap fixes — super-list, accrual booking, writeoff
apiName loanWriteoff loanRepayment foreclosure prepayment dpiAccrualBooking tables dpi_accrual_details loan_due_details reference BILLED_DPI_INT_AMT LoanDueDetailsSuperListUtil GAP-070 GAP-071 GAP-072 GAP-073

---


## 2026-06-16 | workspace | kb-only | DPIC setup stack: preflight, EMI verify, phased demo brain runbook
scripts/dpic/lib/preflight.sh + run_preflight.sh; verify_prerequisites EMI/DPI_BILLED_INTEREST gates; phase1 schedule assert; brain/runbooks/dpic-demo-local.md; Makefile dpic-phase* targets; canned 20-dpic-negative-dues.

---

## 2026-06-16 | workspace | kb-only | DPIC demo phased suite + product 6367 EMI setup fix
Product 6367 loan_product 2886: installment_multiples_of THOUSAND→ZERO in setup_local_dev_product_6367.sql (negative tail PRIN/INT on ₹50k/24mo). Demo: run_demo.sh status + phase1..4 one-at-a-time; registry cleaned (removed legacy step_* cases); state file unified dpic_demo_state.env.

---

## 2026-06-16 | acct `387643f16` | accounting-v2 | feature/delayed_payment_interest | kg-flow | loanAccountTransactionReversal dpi_amount INITIATE/APPROVE
KG-FLOW: loanAccountTransactionReversal — request/approval templates + GetTransactionReversalTaskDetailsProcessor put DPI on APPROVE; reversal payment row dpi_amount populated. transaction_reversal_details dpi_amount.

---

KG-FLOW: dpiAccrualCalculation — DpiAccrualCalculationBatchService sets base_amount from overdue PRIN+INT snapshot; removed overdue_date from DpiAccrualDetailsEntity. dpi_accrual_details.

---


## 2026-06-15 | acct `ad9ecdd69` | accounting-v2 | feature/delayed_payment_interest | kg-flow | DPIC: exclude zero DPI rows from booking mark
KG-FLOW: dpiAccrualCalculation dpiAccrualBooking — markAccrualPostedTillDate and getUnpostedAccruedAmountTillDate filter total_accrued_amount > 0; softDeleteZeroUnpostedAnchors after calc. dpi_accrual_details.

---

---

## 2026-06-13 | acct `3966ffa3c` | accounting-v2 | feature/delayed_payment_interest | kg-flow | DPIC: fetchLoanForeclosureSimulationDetails billed_dpi from super-list
`fetchLoanForeclosureSimulationDetails` returned `billed_dpi=0` after dpiBilling: `LoanDueDetailsSuperListUtil.getPendingInstallmentAmountByComponent` summed only PRIN/INT when `LOAN_DUE_DETAILS_ENTITY_SUPER_LIST` was loaded. Added DPI outstanding sum (`due_date <= asOnDate`). Table `loan_due_details`. Runtime: LAN 6004039425 → `billed_dpi=50`.

## 2026-06-12 | acct `20e4cd878` | accounting-v2 | feature/delayed_payment_interest | kg-flow | DPIC: dpiAccrualCalculation one row per installment
`DpiAccrualCalculationBatchService` daily loop UPDATEs the single open unposted/unbilled row per next-due installment (`total_accrued_amount` accumulates, `end_date` advances) instead of INSERT per day; new row only at month-end split, new installment, or after booking seals prior row. Booking/billing/Loan360 use SUM — aggregate-safe; ~30 rows/mo → ~1–2/installment. Build green. Runtime verified on demo LAN post-pull.

## 2026-06-12 | acct `4b5ec73d6` | accounting-v2 | feature/delayed_payment_interest | kg-flow | DPIC: dpiAccrualBooking month-end + EMI GL
`DpiAccrualBookingBatchService` posts aggregated accrual GL at month-end and on EMI due dates; `markAccrualPostedTillDate` seals rows. Readers stay light.

## 2026-06-12 | acct `8d0df267f` + iset `7e6f0e38` | accounting-v2 + initial-setup | feature/delayed_payment_interest | kg-flow | DPIC: dpiAccrualBooking / dpiBilling postTransaction 333
`dpiAccrualBooking` / `dpiBilling` batches (`DpiAccrualBookingBatchService`, `DpiBillingBatchService`) omitted `office_id` and `operation_mode` (interest booking sets both) → `postTransaction` / `executeTransactionRulesProcessor` error **333** / null office. Table `dpi_accrual_details.accrual_transaction_ref_number` was `varchar(32)` while `postTransaction` returns 37-char refs → Hibernate flush on 2nd `dpiAccrualBooking` row failed `value too long for type character varying(32)` (misleading stack at `getTransactionCatalogueIdProcessor`). Fix: set `office_id` + `operation_mode=SYSTEM`; entity `@Column(64)`; Flyway `V000187` widens both ref columns to 64. Local dev verified: `dpiAccrualBooking` 90/90, `dpiBilling` 2 EMI windows on loan 8055060 (office 1). Merged upstream PR #7625 / #4802.

## 2026-06-12 | acct `8f1be5234` | accounting-v2 | feature/delayed_payment_interest | kg-flow | DPIC: dpiAccrualCalculation earliest-overdue window
