...
| File | Contents |
|------|----------|
| [`system/11-glossary.md`](../system/11-glossary.md) | Modules, infra libs, domain terms (LAN, NEFT, KFS), ExecutionContext/orchestration/JTF definitions, error-code ranges, sample status enums |
