-- Local setup — product 6367 BILLING/NORMAL_BILLING catalogue + placeholder→IAD map.
--
...
-- Account Definition configuration missing") because product 6367 has no
-- product__transaction_catalogue row for transaction_catalogue_id=7
-- (BILLING/NORMAL_BILLING). Products 1, 2 and 44 have it; product 6367 does not — its 3 active loans fail the full-portfolio billing smoke.
--
