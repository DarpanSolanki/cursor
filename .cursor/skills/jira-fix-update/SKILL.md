...
| **`tdpqa_field_handoff`** | **TDPQA** | Custom fields (`11999` RCA / `12008` Impact / `12007` PrePost / `12000` AITDP Dev remarks / `12001` Dev Accuracy / **`12002` Fix Grade** / **`12003` Fix Score** / **`12004` Lead Accuracy** / **`12005` Lead Remarks** / `12009` Yes / `12006` Micro). **Mandatory for QA Test.** **No Dev Test field** — always include `dev[]` in the pack; helper posts a companion comment headed **Dev Test Details** (+ optional **How to retest**). Short ping can be the comment lead-in. |
...
| AiTDP Fix Quality Grade (`12002`) | Short text (`A` / `B` / `NA`). Payload `aitdp_fix_grade` (default `A`). **Mandatory for QA Test** |
| AiTDP Fix Quality Score (`12003`) | Number. Payload `aitdp_fix_score` (defaults to Dev Accuracy whole %). **Mandatory for QA Test** |
...
- [ ] **TDPQA only:** fields `11999`/`12008`/`12007`/`12000`/`12001`/`12002` Fix Grade/`12003` Fix Score/`12004` Lead Accuracy/`12005` Lead Remarks/`12009`/`12006` filled; **`dev[]` companion comment** with Dev Test Details (required — no Dev Test field)
