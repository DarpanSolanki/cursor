...
Each `*.md` here is the full former alwaysApply body. Thematic alwaysApply rules under `.cursor/rules/0*-*.mdc` state each gate **once**; open these files when you need the full historical wording or examples.
